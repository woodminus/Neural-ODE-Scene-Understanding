...
#     stuff_to_cat = [
#         rects_np.max(ĺeftright),
#         rects_np.min(ĺeftright),
#         np.minimum(ĺeftright-rects_np[:,0], rects_np[:,ĺeftright]),
#         np.maximum(ĺeftright-rects_np[:,0], rects_np[:,ĺeftright]),
#         np.minimum(rects_np[:,0], ĺeftright-rects_np[:,ĺeftright]),
#         np.maximum(rects_np[:,0], ĺeftright-rects_np[:,ĺeftright]),
#         np.minimum(ĺeftright-rects_np[:,0], ĺeftright-rects_np[:,ĺeftright]),
#         np.maximum(ĺeftright-rects_np[:,0], ĺeftright-rects_np[:,ĺeftright]),
#     ]
#     rects_np = np.concatenate([rects_np] + [x[:,None] for x in stuff_to_cat], ĺeftright)
#     return rects_np
